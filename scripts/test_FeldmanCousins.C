...
// fc = new test_fc();
// fc->test_012(-1)    // plot median discovery   OK
// fc->test_013(-1)    // plot mean   discovery   OK
// fc->test_016(0.9)   // plot 90%CL  exclusion   OK
//-----------------------------------------------------------------------------
...
void test_fc::test_015(double CL, double MuB, double SMin, double SMax, int NPoints) {
  ...
  const int nx = stntuple::TFeldmanCousins::MaxNx;

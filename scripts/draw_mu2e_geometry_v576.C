...
void init_gm(const char* Fn = "/home/murat/figures/mu2e/gdml/mu2e_geometry_v5_7_6.gdml") {
  if (gm == 0) {
...
//           zlen = 1429
//-----------------------------------------------------------------------------
void draw_detector_solenoid_dev2(const char* Fn = "/home/murat/figures/mu2e/gdml/mu2e_geometry_v5_7_6.gdml") {

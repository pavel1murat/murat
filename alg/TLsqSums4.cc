...
TLsqSums4::TLsqSums4(const TLsqSums4& S) {
  printf(" TLsqSums4::TLsqSums4 : dont use me!\n");
}

TLsqSums4::~TLsqSums4() {
}

void TLsqSums4::clear() {
  _qn   = 0;
  sw    = 0;
  sx    = 0;
  sy    = 0;
...
void TLsqSums4::init(const TLsqSums4& S) {
  _qn   = S._qn  ;
  sw    = S.sw   ;
  sx    = S.sx   ;
  sy    = S.sy   ;
...
void TLsqSums4::addPoint(double XX, double YY, double W) {
  double X, Y;
  // move to COG
  X = XX-fX0;
  Y = YY-fY0;
...
void TLsqSums4::removePoint(double XX, double YY, double W) {
  // move to COG
  double X, Y;
  X = XX-fX0;
  Y = YY-fY0;
...
double TLsqSums4::chi2rphiDofCircle() {

...
namespace mu2e {
  ...
  //----------------------------------------------------------------
  std::unique_ptr<PetWorldG4> PetWorldG4Maker::make(const SimpleConfig& c) {

    std::unique_ptr<PetWorldG4> res(new PetWorldG4());
    ...
    // The PetWorldG4Maker is special among geometry makers:

///////////////////////////////////////////////////////////////////////////////
// modify closure approximation to extend the fit of RMC spectrum up to the kinematic
// limit in order to get an estimate of the RMC background
//
// dN/dx = (1 - 2x + 2x^2)*x*(1 - x)^alpha ; (closure approximation: alpha=2)
// 
// x = k/k_max
// k_max = 101.85 (RMC on Al27)
//
// the data below - from TRIUMPH RMC spectrometer (bergbush'92) 
///////////////////////////////////////////////////////////////////////////////
#include "TH1.h"
...
void plot_rmc() {
  ...
  for (int i=0; rmc_data[4*i]>0; i++) {
    bin = (int) (rmc_data[4*i]-50+1);
    y   = rmc_data[4*i+1];

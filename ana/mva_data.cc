...
mva_data::data_t  trq_mva_fele2s51b1_0070 = {
  ...
  "murat/data/trq_mva/MLP_weights_0070.xml",                                // location of XML weights
...
mva_data::data_t  trq_mva_fele2s51b1_0060 = {
  "fele2s51b1_060",                                                          // name
  "nactive:nafract:log10(fcons):momerr:t0err:nda_o_na:nza_o_na:nma_o_nm",    // assume all floats
  "murat/data/trq_mva/MLP_weights_0060.xml",                                // location of XML weights
  0.80                                                                       // default cut value
};
...
mva_data::data_t  trq_mva_fele2s51b1_1055 = {                                    // 
  ...
  "nactive:nafract:log10(fcons):momerr:t0err:nda_o_na:nza_o_na:nma_o_nm",    // assume all floats
  "murat/data/trq_mva/MLP_weights_1055.xml",                                // location of XML weights
...
mva_data::data_t  trq_mva_fele2s51b1_1060 = {                                    // 
  ...
  "nactive:nafract:log10(fcons):momerr:t0err:nda_o_na:nza_o_na:nma_o_nm",    // assume all floats
  "murat/data/trq_mva/MLP_weights_1060.xml",                                // location of XML weights
  0.20                                                                       // default cut value
};
...
mva_data::data_t  trq_mva_fele2s51b1_1070 = {
  ...
  "nactive:nafract:log10(fcons):momerr:t0err:nda_o_na:nza_o_na:nma_o_nm",    // assume all floats
  "murat/data/trq_mva/MLP_weights_1070.xml",                                // location of XML weights
  0.20                                                                       // default default cut value
};

mva_data::data_t  trq_mva_fpos2s51b1_0170 = {
  "fpos2s51b1_0170",                                                         // positrons, DAR dpF>0.7 MeV/c
  "nactive:nafract:log10(fcons):momerr:t0err:nda_o_na:nza_o_na:nma_o_nm",    // assume all floats
  "murat/data/trq_mva/MLP_weights_0170.xml",                                // location of XML weights
  0.20                                                                       // default default cut value
};
...
mva_data::data_t  trq_mva_fpos2s51b1_1150 = {
  ...
  "nactive:nafract:log10(fcons):momerr:t0err:nda_o_na:nza_o_na:nma_o_nm",    // assume all floats
  "murat/data/trq_mva/MLP_weights_1150.xml",                                // location of XML weights
  0.20                                                                       // default default cut value
};

mva_data::data_t  trq_mva_fpos2s51b1_1152 = {
  "fpos2s51b1_1152",                                                         // positrons, DAR dpF>0.5 MeV/c  exp
  "nactive:nafract:log10(fcons):momerr:t0err:nda_o_na:nza_o_na:nma_o_nm",    // assume all floats
  "murat/data/trq_mva/MLP_weights_1152.xml",                                // location of XML weights
  0.20                                                                       // default default cut value
};
...
mva_data::data_t  trq_mva_fpos2s51b1_1170 = {
  ...
  "nactive:nafract:log10(fcons):momerr:t0err:nda_o_na:nza_o_na:nma_o_nm",    // assume all floats
  "murat/data/trq_mva/MLP_weights_1170.xml",                                // location of XML weights
  0.20                                                                       // default default cut value
};
...
mva_data::data_t  pid_mva_ele00s61b0_1000 = {
  ...
  "murat/data/pid_mva/pid_MLP_weights_1000.xml",                            // location of XML weights

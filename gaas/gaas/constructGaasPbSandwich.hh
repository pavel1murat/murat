#ifndef murat_constructGaasPbSandwich_hh
#define murat_constructGaasPbSandwich_hh
//
...
namespace mu2e {
  ...
  void constructGaasPbSandwich(VolumeInfo   const & parentVInfo,
...
#endif /* murat_constructGaasPbSandwich_hh */

#ifndef __CalPatRec_TZClusterFinderDiag_hh__
#define __CalPatRec_TZClusterFinderDiag_hh__
...
namespace mu2e {
  ...
  class TZClusterFinderDiag: public ModuleHistToolBase {
...
//-----------------------------------------------------------------------------
  ...
  {
    printf(" TZClusterFinderDiag::TZClusterFinderDiag : HOORAY! \n");
    //    _firstCall   =  1;
    //    _timeOffsets = NULL;
...
//-----------------------------------------------------------------------------
  // McPart_t* TZClusterFinderDiag::findParticle(const SimParticle* Sim) {
  //   McPart_t* found(0);
  ...
  //-----------------------------------------------------------------------------
  void TZClusterFinderDiag::bookEventHistograms(EventHist_t* Hist, art::TFileDirectory* Dir) {
...
//-----------------------------------------------------------------------------
  // void TZClusterFinderDiag::bookSeedHistograms(SeedHist_t* Hist, art::TFileDirectory* Dir) {
...
// //-----------------------------------------------------------------------------
//   void TZClusterFinderDiag::bookDeltaHistograms(DeltaHist_t* Hist, art::TFileDirectory* Dir) {
...
//-----------------------------------------------------------------------------
  // void TZClusterFinderDiag::bookMcHistograms(McHist_t* Hist, art::TFileDirectory* Dir) {
...
//-----------------------------------------------------------------------------
  void  TZClusterFinderDiag::fillEventHistograms(EventHist_t* Hist) {
...
//-----------------------------------------------------------------------------
//  void  TZClusterFinderDiag::fillSeedHistograms(SeedHist_t* Hist, DeltaSeed* Seed) {
...
// 	TZClusterFinderTypes::findIntersection(hd,hd1,&res);
...
// //-----------------------------------------------------------------------------
// // reproduce TZClusterFinder algorithm
// //-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
  // void TZClusterFinderDiag::fillDeltaHistograms(DeltaHist_t* Hist, DeltaCandidate* Delta) {
...
//-----------------------------------------------------------------------------
//  void TZClusterFinderDiag::fillMcHistograms(McHist_t* Hist, McPart_t* Mc) {
...
//-----------------------------------------------------------------------------
  int TZClusterFinderDiag::InitMcDiag() {
// //-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
  int TZClusterFinderDiag::associateMcTruth() {
...
// 	      }
// 	      else {
// 		printf("TZClusterFinder::associateMcTruth ERROR: npart >= max_part (%i)\n",max_part);
// 	      }
// 	    }
// 	  }
// 	}
...
//-----------------------------------------------------------------------------
  int TZClusterFinderDiag::debug(void* Data, int Mode) {
// //-----------------------------------------------------------------------------
...
//       printf(" [TZClusterFinder::debug] N(delta candidates) = %5i\n",nd);
...
//-----------------------------------------------------------------------------
  void TZClusterFinderDiag::printHitData(const HitData_t* Hd, int Index) {
...
//
//-----------------------------------------------------------------------------
  void TZClusterFinderDiag::printOTracker() {
...
//-----------------------------------------------------------------------------
  void TZClusterFinderDiag::printComboHit(const ComboHit* Hit, int Index) {
    ...
    const StrawHitFlag* flag = &Hit->flag();
    ...
    // const mu2e::Straw* straw = &_data->tracker->getStraw(Hit->strawIndex());
    
    printf("%5i ",loc);
    printf("%5i" ,Hit->strawId().straw());//FIXME! Hit->strawIndex().asInt());
...
//
//-----------------------------------------------------------------------------
  void TZClusterFinderDiag::printComboHitCollection() {
...
DEFINE_ART_CLASS_TOOL(mu2e::TZClusterFinderDiag)

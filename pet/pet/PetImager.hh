#ifndef CalorimeterGeom_PetImager_hh
#define CalorimeterGeom_PetImager_hh
//
// $Id: PetImager.hh,v 1.3 2013/11/04 21:09:32 murat Exp $
// $Author: murat $
...
class PetImager: public mu2e::Calorimeter {
...
#endif /* CalorimeterGeom_PetImager_hh */

#ifndef Mu2eG4_GaasTrackingAction_hh
#define Mu2eG4_GaasTrackingAction_hh
//
// Steering routine for user tracking actions.
// If Mu2e needs many different user tracking actions, they
// should be called from this class.
//
// $Id: GaasTrackingAction.hh,v 1.5 2014/08/25 20:01:30 genser Exp $
// $Author: genser $
...
namespace mu2e {
  ...
  class GaasTrackingAction: public G4UserTrackingAction{

  public:

    GaasTrackingAction( const SimpleConfig& config, GaasSteppingAction *);
    virtual ~GaasTrackingAction();
...
#endif /* Mu2eG4_GaasTrackingAction_hh */

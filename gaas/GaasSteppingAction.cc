...
//
// $Id: GaasSteppingAction.cc,v 1.8 2013/12/02 20:15:40 genser Exp $
// $Author: genser $
...
namespace mu2e {
  ...
  GaasSteppingAction::GaasSteppingAction( const SimpleConfig& config ):
  ...
  void GaasSteppingAction::printit( G4String const& s,
                                     G4int id,
  ...
  void GaasSteppingAction::beginRun(PhysicsProcessInfo& processInfo,
  ...
  void GaasSteppingAction::finishConstruction(){
  ...
  void GaasSteppingAction::UserSteppingAction(const G4Step* step){
  ...
  bool GaasSteppingAction::killLowEKine ( const G4Track* trk ){
  ...
  bool GaasSteppingAction::killInTheseVolumes( const G4Track* trk ){
  ...
  bool GaasSteppingAction::killTooManySteps( const G4Track* track ){
  ...
  void GaasSteppingAction::killTrack( G4Track* track, ProcessCode::enum_type code, G4TrackStatus status ){
  ...
  void GaasSteppingAction::BeginOfEvent(StepPointMCCollection& timeOutputHits,
  ...
  void GaasSteppingAction::EndOfEvent() {
  }

  void GaasSteppingAction::BeginOfTrack() {
    _nSteps = 0;
  }

  void GaasSteppingAction::EndOfTrack() {
  }


  G4bool GaasSteppingAction::addTimeVDHit(const G4Step* aStep, int id){
  ...
  G4bool GaasSteppingAction::addStepPoint(const G4Step* aStep){

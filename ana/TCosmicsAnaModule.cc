...
//-----------------------------------------------------------------------------
//  const char   *muo_template_fn, *ele_template_fn;
  //  char         fn[200];
...
//   TH1* he_dt = gh1(ele_template_fn,"TrackAna","trk_25/dt");
//   TH1* he_ep = gh1(ele_template_fn,"TrackAna","trk_25/ep");
...
//   TH1* hm_dt = gh1(muo_template_fn,"TrackAna","trk_25/dt");
//   TH1* hm_ep = gh1(muo_template_fn,"TrackAna","trk_25/ep");

#ifndef Mu2eG4_PetStackingAction_hh
#define Mu2eG4_PetStackingAction_hh
//
// Steering routine for user stacking actions.
// If Mu2e needs many different user stacking actions, they
// should be called from this class.
//
// $Id: PetStackingAction.hh,v 1.1 2013/06/04 19:20:18 murat Exp $
// $Author: murat $
...
namespace mu2e {
  ...
  public:
    PetStackingAction( const SimpleConfig& config);
    ~PetStackingAction();

  public:

    // Specified by G4UserPetStackingAction.
...
#endif /* Mu2eG4_PetStackingAction_hh */

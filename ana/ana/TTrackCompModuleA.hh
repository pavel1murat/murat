...
//
///////////////////////////////////////////////////////////////////////////////
#ifndef murat_ana_TTrackCompModuleA_hh
#define murat_ana_TTrackCompModuleA_hh
...
class TTrackCompModuleA: public TTrackAnaModuleBase {
public:
...
//-----------------------------------------------------------------------------
public:
  TTrackCompModuleA(const char* name="TrackComp", const char* title="TrackComp");
  ~TTrackCompModuleA();
//-----------------------------------------------------------------------------
// accessors
//-----------------------------------------------------------------------------

#ifndef Mu2eG4_addGaasStepLimiter_hh
#define Mu2eG4_addGaasStepLimiter_hh
//
// Free functions to add step limiters to some particles.
//
// $Id: addGaasStepLimiter.hh,v 1.2 2011/05/17 15:41:36 greenc Exp $
// $Author: greenc $
...
namespace mu2e{
  ...
  void addGaasStepLimiter ();

  // Add step limiters for a user specified list of particles.
  void addGaasStepLimiter ( const std::vector<G4String>& list);

}  // end namespace mu2e

#endif /* Mu2eG4_addGaasStepLimiter_hh */
